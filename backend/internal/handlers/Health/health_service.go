...
func (h *HealthService) CheckHealth(c *fiber.Ctx) (*utils.ResponseBody[types.HealthResponse], error) {
	response := &utils.ResponseBody[types.HealthResponse]{}
...
func (h *HealthService) Health(c *fiber.Ctx) (*utils.ResponseBody[types.HealthResponse], error) {
	response := &utils.ResponseBody[types.HealthResponse]{}
