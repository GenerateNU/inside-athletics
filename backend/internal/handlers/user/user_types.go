...
type UpdateUserBody struct {
	...
	Bio                   *string                       `json:"bio,omitempty" example:"My name is Suli and I'm a pro athlete" doc:"The bio of a user"`
	ProfileImageKey       *string                       `json:"profile_image_key,omitempty" example:"profiles/users/example.png" doc:"S3 key for the user's profile image" gorm:"column:profile_picture"`
