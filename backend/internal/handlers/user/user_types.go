...
type GetUserResponse struct {
	...
	ProfileImageKey       *string                      `json:"profile_image_key,omitempty" example:"profiles/users/example.png" doc:"S3 key for the user's profile image"`
	ProfileImageURL       *string                      `json:"profile_image_url,omitempty" example:"https://bucket.s3.amazonaws.com/profiles/users/example.png" doc:"Signed URL for the user's profile image"`
