...
type GetCollegeResponse struct {
	...
	AthleticsWebsite string          `json:"athletics_website" example:"https://www.huskies.edu" doc:"Athletics website for college"`
...
type CreateCollegeRequest struct {
	...
	AthleticsWebsite string          `json:"athletics_website" required:"true" minLength:"1" maxLength:"500" example:"https://www.huskies.edu" doc:"Athletics website for college"`
	AcademicRank     *int16          `json:"academic_rank" example:"53" doc:"Academic rank of the college"`
...
type UpdateCollegeRequest struct {
	...
	AthleticsWebsite *string          `json:"athletics_website" maxLength:"500" example:"https://www.huskies.edu" doc:"Athletics website for college"`
	AcademicRank     *int16           `json:"academic_rank" example:"53" doc:"Academic rank of the college"`
	DivisionRank     *models.Division `json:"division_rank" enum:"1,2,3" example:"1" doc:"NCAA division (1, 2, or 3)"`
	Logo             *string          `json:"logo" maxLength:"500" example:"https://example.com/logo.png" doc:"Logo of the college"`
}
