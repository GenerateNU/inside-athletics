...
type User struct {
	...
	Email                   string                `json:"email" example:"suli123@email.com" doc:"The email of a user" gorm:"type:varchar(100);not null;unique"`
	Username                string                `json:"username" example:"suliproathelete" doc:"The username of a user" gorm:"type:varchar(100);not null;unique"`
	Bio                     *string               `json:"bio" example:"My name is Suli and I'm a pro athlete" doc:"The name of a user" gorm:"type:varchar(100);"` //nullable
	Account_Type            bool                  `json:"account_type" example:"True" doc:"If the user has access to premium features" gorm:"type:bool;not null;default:false"`
	...
	Verified_Athlete_Status VerifiedAthleteStatus `json:"verified_athelete_status" example:"pending" doc:"" gorm:"type:varchar(100);not null;default:none"`
	College                 *string               `json:"college" example:"Northeastern University" doc:"The college of a user" gorm:"type:varchar(100);"` //nullable
	Division                *Division             `json:"division" example:"1" doc:"The divison of their college" gorm:"type:uint;"` //nullable
}
