...
export const updateUserBodySchema = z.object({
  ...
  account_type: z.optional(
    z.boolean().describe("If the user has access to premium features"),
  ),
  ...
  verified_athlete_status: z.optional(
    z.string().describe("Verification status for the athlete"),
  ),
});
