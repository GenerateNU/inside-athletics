...
get "roles"(){
                return z.array(roleResponseSchema).describe("Roles assigned to the user").optional()
              },
get "sport"(){
                return sportSchema.describe("The sport(s) the user is interested in").optional()
              },
