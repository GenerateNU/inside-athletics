...
export function getApiV1SportsQueryOptions(
 ...
 * {@link /api/v1/sports/}
 */
export function useGetApiV1Sports<
  TData = GetApiV1SportsQueryResponse,
  TQueryData = GetApiV1SportsQueryResponse,
  TQueryKey extends QueryKey = GetApiV1SportsQueryKey,
>(
  params?: GetApiV1SportsQueryParams,
  options: {
    query?: Partial<
