...
export type GetApiV1PostsByAuthorByAuthorIdQueryKey = ReturnType<
  typeof getApiV1PostsByAuthorByAuthorIdQueryKey
>;

export function getApiV1PostsByAuthorByAuthorIdQueryOptions(
  author_id: GetApiV1PostsByAuthorByAuthorIdPathParams["author_id"],
  params?: GetApiV1PostsByAuthorByAuthorIdQueryParams,
 ...
 */
export function useGetApiV1PostsByAuthorByAuthorId<
  TData = GetApiV1PostsByAuthorByAuthorIdQueryResponse,
  TQueryData = GetApiV1PostsByAuthorByAuthorIdQueryResponse,
  TQueryKey extends QueryKey = GetApiV1PostsByAuthorByAuthorIdQueryKey,
>(
  author_id: GetApiV1PostsByAuthorByAuthorIdPathParams["author_id"],
  params?: GetApiV1PostsByAuthorByAuthorIdQueryParams,
  options: {
