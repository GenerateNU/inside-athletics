...
export type GetApiV1SportsSuspenseQueryKey = ReturnType<
  typeof getApiV1SportsSuspenseQueryKey
>;

export function getApiV1SportsSuspenseQueryOptions(
  params?: GetApiV1SportsQueryParams,
 ...
 * {@link /api/v1/sports/}
 */
export function useGetApiV1SportsSuspense<
  TData = GetApiV1SportsQueryResponse,
  TQueryKey extends QueryKey = GetApiV1SportsSuspenseQueryKey,
>(
  params?: GetApiV1SportsQueryParams,
  options: {
    query?: Partial<
