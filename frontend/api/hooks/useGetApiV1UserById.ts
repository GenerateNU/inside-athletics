...
export type GetApiV1UserByIdQueryKey = ReturnType<
  typeof getApiV1UserByIdQueryKey
>;

export function getApiV1UserByIdQueryOptions(
  id: GetApiV1UserByIdPathParams["id"],
 ...
 * {@link /api/v1/user/:id}
 */
export function useGetApiV1UserById<
  TData = GetApiV1UserByIdQueryResponse,
  TQueryData = GetApiV1UserByIdQueryResponse,
  TQueryKey extends QueryKey = GetApiV1UserByIdQueryKey,
>(
  id: GetApiV1UserByIdPathParams["id"],
  options: {
    query?: Partial<
